    ...
    "step": [
      {
        ...
        "text": "Install the latest stable PyPI release using pip: 'pip install vastai'. This will install the vastai-sdk package which provides convenient Python access to the Vast.ai API."
      },
      {
        "@type": "HowToStep",
