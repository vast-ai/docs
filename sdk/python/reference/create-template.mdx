...
<ParamField path="disk_space" type="Optional[float]">
...
<ParamField path="use_ssh" type="Optional[bool]">
  
</ParamField>

<ParamField path="jup_direct" type="Optional[bool]">
  
</ParamField>

<ParamField path="ssh_direct" type="Optional[bool]">
  
</ParamField>

<ParamField path="use_jupyter_lab" type="Optional[bool]">
  
</ParamField>

<ParamField path="docker_login_repo" type="Optional[str]">
  
</ParamField>

<ParamField path="extra_filters" type="Optional[dict]">
  
</ParamField>

<ParamField path="readme_visible" type="Optional[bool]">
  
</ParamField>

<ParamField path="private" type="Optional[bool]">
