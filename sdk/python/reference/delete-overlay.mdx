...
<ParamField path="overlay_identifier" type="str" default="None">
  The identifier of the overlay to delete.
</ParamField>
...
result = client.delete_overlay(overlay_identifier="my-overlay")
print(result)
```
