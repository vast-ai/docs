...
const checks=['python-integration-02','reviewer-integration-03','model-current-check-02',
 ...
 'html-tests-final-04','browser-authority-final-04','browser-passages-current-01','package-final-03'];
...
for(const [record,names] of [['python-integration-02',p=>p.endsWith('.py')||p.startsWith('host/')||p.startsWith('verification/current-')],
 ...
 ['html-tests-final-04',p=>['scripts/templates/host-docs-review.html','scripts/host-review-html.test.mjs','verification/host-docs-review.html'].includes(p)]]) {
...
const browser=read(dir+'/reviewer-browser-final-04/result.json');
