...
const dir='verification/evidence/2026-09-14-payout-invoice-correction-attempt-01',file=dir+'/root-visible-check-01.json';
...
try{
 ...
 if(target.url!=='file://'+path.resolve('verification/host-docs-review.html')||target.claim!=='MCL-3afd93ae0b6cf8a4'||!target.open)throw Error('Unexpected target');
