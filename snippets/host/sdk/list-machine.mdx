...
Volume and duration listing parameters (`vol_size`, `vol_price`, `duration`, `price_min_bid`) require the CLI or REST API today — they are not in the SDK signature below.
</Note>
