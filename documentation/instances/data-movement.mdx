...
You can also access this feature using the `vastai cloud copy` [CLI command](https://docs.vast.ai/cli/commands).
...
You can also access this feature using the `vastai copy` [CLI command](https://docs.vast.ai/cli/commands).

## CLI Copy Command

You can use the [CLI](https://docs.vast.ai/cli/get-started) copy command to copy from/to directories on a remote instance and your local machine, or to copy data between two remote instances.
...
You can use the [CLI](https://docs.vast.ai/cli/get-started) vm copy command to copy your entire VM from one instance to another. The destination VM's disk will be replaced with the contents of the source machine.
