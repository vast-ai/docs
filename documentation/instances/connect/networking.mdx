...
"canonical": "/documentation/instances/connect/networking"
---
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "TechArticle",
    "headline": "Vast.ai Networking and Port Configuration",
    "description": "Understanding Vast.ai networking including how Docker instances share IP addresses with random port mapping, opening custom ports using Docker options or EXPOSE, finding mapped ports, identity ports, port environment variables, and UI control variables.",
    "author": {
      "@type": "Organization",
      "name": "Vast.ai"
    },
    "articleSection": "Instances Documentation",
    "keywords": ["networking", "ports", "port mapping", "Docker", "environment variables", "vast.ai"]
  })
}} />
