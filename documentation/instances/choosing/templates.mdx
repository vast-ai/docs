...
"canonical": "/documentation/instances/choosing/templates"
---
...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "TechArticle",
    "headline": "Choosing Vast.ai Templates",
    "description": "Understanding Vast.ai templates - saved configurations that define Docker image, launch mode (SSH, Jupyter, Entrypoint), initialization scripts, and networking for your instances, including recommended templates, custom options, and troubleshooting common issues.",
    "author": {
      "@type": "Organization",
      "name": "Vast.ai"
    },
    "articleSection": "Instances Documentation",
    "keywords": ["templates", "Docker images", "SSH", "Jupyter", "launch modes", "configuration", "vast.ai"]
  })
}} />
