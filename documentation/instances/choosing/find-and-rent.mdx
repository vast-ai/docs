...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "HowTo",
    "name": "How to Find and Rent GPU Instances on Vast.ai",
    "description": "A complete guide to finding and renting GPU instances on Vast.ai including understanding the search page, offer cards, machine tiers, disk size configuration, and troubleshooting common issues.",
    "step": [
      {
        "@type": "HowToStep",
        "name": "Navigate to the Search Page",
        "text": "Go to the Vast.ai search page which is the main portal for finding machines and creating instances. Use the search options on the top and left control bars to filter by location, GPU type and count, hardware specs, rental parameters, and other criteria."
      },
      {
        "@type": "HowToStep",
        "name": "Understand Offer Cards",
        "text": "Review offer cards which contain detailed information about available offers for rent. Each card shows machine tier (Unverified, Verified, or Datacenter), location and host ID, GPU model and count, performance metrics, CPU and RAM specs, storage details, network configuration, DLPERF score, pricing breakdown, maximum duration, and reliability score."
      },
      {
        "@type": "HowToStep",
        "name": "Configure Instance Disk Size",
        "text": "Use the storage slider to set the disk allocation size before creating the instance. The default is 10GB but can be adjusted. Remember that disk size cannot be modified after instance creation and providers charge for disk allocation even when the instance is stopped."
      },
      {
        "@type": "HowToStep",
        "name": "Select or Configure Template",
        "text": "Access the instance configuration menu in the upper left to select a template. Click 'Change Template' to choose or edit templates which define your Docker image, run commands, on-start script, and launch mode (SSH, Jupyter, or Entrypoint)."
      },
      {
        "@type": "HowToStep",
        "name": "Rent the Instance",
        "text": "Click the RENT button on your selected offer card to create the instance. If you get 'offer is no longer available', the machine was rented by someone else - simply try another offer. Once rented, the instance will begin loading and you'll be able to connect when it's ready."
      }
    ]
  })
}} />
