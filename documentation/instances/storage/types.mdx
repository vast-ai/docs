...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "TechArticle",
    "headline": "Vast.ai Storage Types",
    "description": "Understanding Vast.ai storage options including container storage (temporary, fixed size at creation, deleted with instance) and volumes (persistent local storage, reattachable, tied to physical machine), including costs, persistence strategies, and backup options.",
    "author": {
      "@type": "Organization",
      "name": "Vast.ai"
    },
    "articleSection": "Instances Documentation",
    "keywords": ["storage", "container storage", "volumes", "persistent storage", "data persistence", "backups", "vast.ai"]
  })
}} />
