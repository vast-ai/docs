  ...
  __html: JSON.stringify({
    ...
    "step": [
      ...
      },
      {
        ...
        "text": "For VM instances, use 'vastai vm copy SOURCE_ID DEST_ID' to transfer entire VM contents to another instance. The destination instance must be stopped during transfer. The destination VM's disk will be completely replaced with the source machine's contents."
      },
      {
        "@type": "HowToStep",
