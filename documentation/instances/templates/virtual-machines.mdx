...
"canonical": "/documentation/instances/templates/virtual-machines"
---
...
First, make sure that you have added your SSH keys to your account page first (see [ssh guide](/documentation/instances/sshscp)), as SSH keys cannot be edited on running VMs. SSH access is currently the only method preconfigured on VM instances.
...
For more details on these options, see [environment](/documentation/instances/docker-execution-environment).
