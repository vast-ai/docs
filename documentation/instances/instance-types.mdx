...
<Info>
For detailed instructions on creating and managing reserved instances, see [Reserved Instances](/documentation/instances/reserved-instances).
</Info>
...
- **Get discounts**: Learn about [Reserved Instances](/documentation/instances/reserved-instances)
- **Start renting**: [Choose an Instance](/documentation/instances/choose-an-instance)