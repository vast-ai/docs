...
Check current market rates in the [Dashboard](https://cloud.vast.ai/create/) or query programmatically via the [CLI](/cli/reference/search-offers) or [API](/api-reference/introduction).
