---
title: Templates for Instances
description: Quick guide to using templates when renting Vast.ai instances. Templates define your Docker image, launch mode, and initialization settings.
---
