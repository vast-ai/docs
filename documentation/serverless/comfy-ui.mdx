...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "description": "API reference for using Comfy UI with Vast.ai Serverless for image generation workflows, including environment variables, /prompt/ endpoint, and /custom_workflow/ endpoint documentation.",
    "author": {
      "@type": "Organization",
      "name": "Vast.ai"
    },
    "articleSection": "Serverless Documentation",
    "keywords": ["ComfyUI", "image generation", "stable diffusion", "serverless", "API", "vast.ai", "SD3", "Flux"]
  })
}} />
