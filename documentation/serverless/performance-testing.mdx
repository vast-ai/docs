...
When the serverless system recruits a GPU for a Worker Group, the PyWorker on the GPU instance starts by conducting a performance test to assess the GPU's maximum capabilities. 
...
For an example of simulating load on your endpoint, check the examples in (https://github.com/vast-ai/vast-sdk/tree/main/examples/client)
