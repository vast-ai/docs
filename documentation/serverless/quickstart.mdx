...
<Note>
  **Need help?** Join our [Discord community](https://discord.gg/hSuEbSQ4X8) or check the [detailed documentation](/documentation/serverless/architecture) for advanced configurations.
</Note>