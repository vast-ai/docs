...
<Note>
  This guide assumes knowledge of the Vast CLI. An introduction for it can be found [here](https://docs.vast.ai/cli/get-started).
</Note>
...
This is everything you need to start, test, and monitor a vLLM + Qwen3-8B Serverless engine! There are other [Vast pre-made [templates](https://docs.vast.ai/templates)](https://docs.vast.ai/serverless/vllm), like the ComfyUI Image Generation model, that can be setup in a similar fashion.&#x20;
