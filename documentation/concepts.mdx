...
"canonical": "/documentation/concepts"
---
...
If you are brand new, you do not need to memorize this page — skim it, then jump to the [Quickstart](/documentation/get-started/quickstart) and come back when a term is unclear.

## Marketplace

### Host

A **host** is anyone who lists GPU hardware on Vast. Hosts range from individuals with a single gaming PC to Tier‑4 datacenters. Each host sets their own prices, reliability expectations, and verification level. The full host-side documentation lives in the [Host](/documentation/host/hosting-overview) tab.
...
You search and filter offers to find GPUs that match your workload. See [Find & rent](/documentation/instances/choosing/find-and-rent).
...
Vast ships recommended templates (built on `vastai/base-image` and `vastai/pytorch`) that include the [Instance Portal](/documentation/templates/introduction#instance-portal), Caddy-based TLS, and authentication. You can also create your own. See [Templates](/documentation/templates/introduction).
...
Details and tradeoffs in [Instance Types](/documentation/instances/choosing/instance-types).
...
<CardGroup cols={2}>
  <Card title="Quickstart" href="/documentation/get-started/quickstart" icon="rocket">
    Rent your first instance
  </Card>
  <Card title="Find & rent" href="/documentation/instances/choosing/find-and-rent" icon="magnifying-glass">
    Learn to search offers effectively
  </Card>
  <Card title="Templates" href="/documentation/templates/introduction" icon="layer-group">
    Pre-built and custom launch configs
  </Card>
  <Card title="Serverless" href="/documentation/serverless/getting-started-with-serverless" icon="bolt">
