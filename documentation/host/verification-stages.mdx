...
> **Note:** If you’ve fixed the issue but the system doesn’t automatically detect the resolution, a Vast.ai team member may need to manually verify that your machine is functioning correctly and clear the error.
