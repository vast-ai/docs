...
<Warning>
**10 Mbps is enough to get listed — but not enough to get verified.**

The 10 Mbps figure above is the minimum to appear on the Vast.ai marketplace. To pass active verification, your machine must achieve **500 Mb/s download and upload** (see requirements below). Hosts who invest in hardware based on the 10 Mbps listing minimum and do not meet the 500 Mbps threshold will remain Unverified indefinitely.
</Warning>
