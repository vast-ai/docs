...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "TechArticle",
    "headline": "Vast.ai VM Support Technical Guide",
    "description": "Technical documentation for hosts on configuring and enabling VM support on Vast.ai using KVM, including benefits, drawbacks, hardware prerequisites, BIOS configuration, and troubleshooting.",
    "author": {
      "@type": "Organization",
      "name": "Vast.ai"
    },
    "articleSection": "Host Documentation",
    "keywords": ["virtual machines", "KVM", "host configuration", "IOMMU", "VMs", "GPU", "Docker", "hosting", "vast.ai"]
  })
}} />
...
VM support expands the range of workloads your machine can serve, though VM instances have higher support exposure due to hardware-level complexity. We recommend enabling VMs only after verifying IOMMU passthrough stability on your specific hardware.
