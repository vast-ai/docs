    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Meeting these minimum requirements makes your machine eligible for verification, but does not automatically guarantee verification. The requirements ensure your machine has the basic quality and reliability benchmarks needed to run client workloads effectively."
        }
      },
      {
        "@type": "Question",
