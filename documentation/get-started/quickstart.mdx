    ...
    "step": [
      {
        ...
        "text": "Create an account on vast.ai, verify your email address, and add credit through Billing using credit card, Bitpay, or Crypto.com. Your balance will appear at the top right of the dashboard."
      },
      {
        "@type": "HowToStep",
  ...
  __html: JSON.stringify({
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "When your balance reaches zero, your running instances will automatically stop. To avoid this, you can enable autobilling on the Billing page. Set an auto-charge threshold higher than your average daily spend, so your card is automatically charged when your balance falls below that amount. We also recommend setting a low-balance email alert at a slightly lower threshold to notify you if the auto-charge fails for any reason."
        }
      },
      {
        "@type": "Question",
...
- Go to [**Billing**](/documentation/reference/billing) → **Add Credit** and top up using [credit card, BitPay, or Crypto.com](/documentation/reference/billing#payment-methods).
