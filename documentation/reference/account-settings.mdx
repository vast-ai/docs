...
- **Teams:** If you **own** a team, it will be deleted — [transfer ownership](/documentation/teams/transfer-team-ownership) if needed. If you’re **a member** of a team, you’ll be removed from it.
