...
<CardGroup cols={2}>
  <Card title="Architecture" icon="sitemap" href="/documentation/deployments/architecture">
    Understand how deploy mode, serve mode, and update tiers work
  </Card>
  <Card title="Configuring Deployments" icon="gear" href="/documentation/deployments/configuration">
    Image, packages, GPU requirements, autoscaling, and environment setup
  </Card>
  <Card title="@remote Functions" icon="bolt" href="/documentation/deployments/remote-functions">
    Define, call, and benchmark remote GPU functions
  </Card>
  <Card title="@context Classes" icon="layer-group" href="/documentation/deployments/context">
