...
![Edithf](/images/huggingface-tgi-with-llama3-edithf.webp)
</Frame>
...
<Frame caption="Rent">
![Rent](/images/huggingface-tgi-with-llama3-rent.webp)
</Frame>
...
![Llama3Tgiinstances](/images/huggingface-tgi-with-llama3-llama3tgiinstances.webp)
</Frame>
...
![Llama3Ip](/images/huggingface-tgi-with-llama3-llama3ip.webp)
</Frame>
...
![Llama3Tgipostman](/images/huggingface-tgi-with-llama3-llama3tgipostman.webp)
</Frame>
...
TGI via a template built to run on Vast Serverless. See the [Serverless Quickstart](/guides/serverless/quickstart).
