    ...
    "step": [
      {
        ...
        "text": "Create a Vast.ai account and verify your email address. Head to the Billing tab and add credits. Vast uses Stripe to process credit card payments and also accepts major cryptocurrencies through BitPay or Crypto.com. $20 should be enough to start. You can setup auto-top ups for when your balance is low."
      },
      {
        "@type": "HowToStep",
