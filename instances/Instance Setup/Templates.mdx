...
![](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/ut6dkB5NnPcoaG1Vs4CwC_image.png)
...
Each template you create and make public can earn you referral credits with the [referral program](https://docs.vast.ai/referral-program). The referral link for each template is shown as a share icon on the template page or as a hash that you can copy in the search interface template menu.
...
![](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/Gkn7XWKurTl7d3BYVkYwu_image.png)

From either interface, the settings are the same. For a complete explanation, see the section [Docker Execution Environment](https://docs.vast.ai/instances/docker-execution-environment) for details on exactly what options are supported.
...
![Spaces Mgwtdaam0Bo2Skpvyo6Q Uploads J4Mlhw1Z6J1Ct0Cpq5My Open Ports](https://vast.ai/uploads/crawl/spaces_mgwtdaam0bo2skpvyo6q_uploads_j4mlhw1z6j1ct0cpq5my_open_ports.jpg "Spaces Mgwtdaam0Bo2Skpvyo6Q Uploads J4Mlhw1Z6J1Ct0Cpq5My Open Ports")
...
See also [Docker Execution Environment](https://docs.vast.ai/instances/docker-execution-environment).
...
![Cert Chrome Windows 1](https://vast.ai/uploads/cert-chrome-windows-1.JPG "Cert Chrome Windows 1")
...
![Cert Windows 1](https://vast.ai/uploads/cert-windows-1.JPG "Cert Windows 1")

1. Click on the "Install Certificate" button. Select either the current user or local machine and hit next.

![Cert Windows 2](https://vast.ai/uploads/cert-windows-2.JPG "Cert Windows 2")
...
![Cert Windows 3](https://vast.ai/uploads/cert-windows-3.JPG "Cert Windows 3")
...
![Cert Macos 1](https://vast.ai/uploads/cert-macos-1.jpg "Cert Macos 1")

1. Change the "When using this certificate" box to "Always Trust".

![Cert Macos 2](https://vast.ai/uploads/cert-macos-2.jpg "Cert Macos 2")
