...
# Comprehensive Guide to Cloud Backups on Vast.ai
...
- [Cloud storage connection set up in Vast.ai]{href="https://docs.vast.ai/instances/cloud-sync" newTab="true" hasDisabledNofollow="false"}
- [(Optional) Install and use vast-cli]{href="https://docs.vast.ai/cli" newTab="true" hasDisabledNofollow="false"}
- [(Optional) Understanding of how to use cron in computers with Unix-like OS]{href="https://cronitor.io/guides/cron-jobs" newTab="true" hasDisabledNofollow="false"}
...
If you don't have a connection yet, you'll need to set one up in [Vast.ai's Settings page ]{href="https://docs.vast.ai/instances/cloud-sync" newTab="true" hasDisabledNofollow="false"}before proceeding with backup operations.
