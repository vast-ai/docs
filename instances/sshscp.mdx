...
<Tabs>
  <Tab title="Terminal">
    ...
    **3. Add it in your&#x20;**[**vast account**]{href="https://cloud.vast.ai/manage-keys/" newTab="true" hasDisabledNofollow="false"}**.**

    ![](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/TBd42WcGjrz97JXDgQzHp_image.png)
  </Tab>

  <Tab title="Vast CLI">
    **Add & Generate SSH Key (using&#x20;**[**Vast CLI**]{href="https://docs.vast.ai/api/overview-and-quickstart" newTab="true" hasDisabledNofollow="false"}**)**
    ...
    2. **Generate an API key in your vast account:**
       1. Open [CLI page]{href="https://cloud.vast.ai/cli/" newTab="true" hasDisabledNofollow="false"}
       2. Create an API key
          ![API Key creation](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/tqBTAy8AeKUcxbgusHkY-_image.png "CLI page")
...
![Connection details](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/EOFFrFmjY1J8swkwzGDr0_image.png "Terminal Connection Options")
...
![Instance SSH session](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/SVbmJT8HsEHScZ4ziDTi7_image.png "Connected to Instance")
...
![](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/-Qee3PiudaktXYw0BKB7F_image.png)
...
<VerticalSplit layout="middle">
  <VerticalSplitItem>
    ...
    ![](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/GNhyqXLAkvG7EA4vIh9mP_image.png "Open Remote Window")
  </VerticalSplitItem>

  <VerticalSplitItem>
    Enter your ssh address details in the box that appears at the top of your window

    ![](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/ytKCBSTgz2V_nDmJxCTic_image.png)
  </VerticalSplitItem>
</VerticalSplit>
...
For more information, see the [VS Code documentation]{href="https://code.visualstudio.com/docs/remote/ssh" newTab="true" hasDisabledNofollow="false"}.
