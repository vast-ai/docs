...
"canonical": "/guides/templates/quickstart"
---
...
<img src="/images/console-templates-light.webp" className="block dark:hidden" alt="Recommended Templates page" />
<img src="/images/console-templates-dark.webp" className="hidden dark:block" alt="Recommended Templates page" />
</Frame>
...
<img src="/images/console-templates-2-light.webp" className="block dark:hidden" alt="NVIDIA CUDA Template card" />
<img src="/images/console-templates-2-dark.webp" className="hidden dark:block" alt="NVIDIA CUDA Template card" />
</Frame>
...
<img src="/images/console-templates-3-light.webp" className="block dark:hidden" alt="Offers page with GPU filter active" />
<img src="/images/console-templates-3-dark.webp" className="hidden dark:block" alt="Offers page with GPU filter active" />
</Frame>
...
<img src="/images/console-templates-4-light.webp" className="block dark:hidden" alt="Instance view with blue open button" />
<img src="/images/console-templates-4-dark.webp" className="hidden dark:block" alt="Instance view with blue open button" />
</Frame>
