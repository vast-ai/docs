...
"canonical": "/guides/templates/advanced-setup"
---
...
For a complete reference of all template settings, see [Template Settings](/guides/templates/template-settings).
...
<Frame caption="Add PROVISIONING_SCRIPT variable">
  <img src="/images/console-create-custom-template-light.webp" className="block dark:hidden" alt="Add PROVISIONING_SCRIPT variable" />
  <img src="/images/console-create-custom-template-dark.webp" className="hidden dark:block" alt="Add PROVISIONING_SCRIPT variable" />
</Frame>
...
2. Create a new template and enter your custom image path in the Image Path:Tag field (see [Template Settings](/guides/templates/template-settings#docker-repository-and-environment))
