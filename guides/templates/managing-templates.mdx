...
"canonical": "/guides/templates/managing-templates"
---
...
<img src="/images/console-templates-16-light.webp" className="block dark:hidden" alt="My templates showing the NVIDIA CUDA - Demo template" />
<img src="/images/console-templates-16-dark.webp" className="hidden dark:block" alt="My templates showing the NVIDIA CUDA - Demo template" />
</Frame>

## Sharing a Template

It's really easy to share your template with other users.  We have two special links you can use and both include your referral code so you can earn if new users sign up - Find more about that [here](/guides/reference/referral-program).

To share, click the three dots icon in the bottom right of the template card.

<Frame caption="Menu shows sharing options">
  <img src="/images/console-templates-17-light.webp" className="block dark:hidden" alt="Menu shows sharing options" />
  <img src="/images/console-templates-17-dark.webp" className="hidden dark:block" alt="Menu shows sharing options" />
</Frame>
...
- If your image is built for a different CPU architecture than your Vast machine, then it won't work. You can try to find a machine with the required CPU architecture using our GUI or [CLI](/cli/hello-world).
