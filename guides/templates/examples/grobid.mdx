...
<Frame>
  <img src="/images/console-creating-templates-for-grobid-light.webp" className="block dark:hidden" alt="GROBID on-start script" />
  <img src="/images/console-creating-templates-for-grobid-dark.webp" className="hidden dark:block" alt="GROBID on-start script" />
</Frame>
