...
- **Resize Disk** - Grow the container disk in place via `vastai update instance <ID> --disk <new_size_gb>` (see [Resizing container storage](/guides/instances/storage/types#resizing-container-storage))
