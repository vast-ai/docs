...
"canonical": "/guides/instances/manage-instances"
---
...
<img src="/images/console-instance-guide-light.webp" className="block dark:hidden" alt="Instances Page" />
<img src="/images/console-instance-guide-dark.webp" className="hidden dark:block" alt="Instances Page" />
</Frame>
...
<Frame caption="Open button">
  <img src="/images/console-instance-guide-2-light.webp" className="block dark:hidden" alt="Open button" />
  <img src="/images/console-instance-guide-2-dark.webp" className="hidden dark:block" alt="Open button" />
</Frame>
...
<Frame caption="ID numbers">
  <img src="/images/console-instance-guide-9-light.webp" className="block dark:hidden" alt="ID numbers" />
  <img src="/images/console-instance-guide-9-dark.webp" className="hidden dark:block" alt="ID numbers" />
</Frame>
...
**Hardware Details:**
<Frame>
  <img src="/images/console-instance-guide-10-light.webp" className="block dark:hidden" alt="Hardware details" />
  <img src="/images/console-instance-guide-10-dark.webp" className="hidden dark:block" alt="Hardware details" />
</Frame>
- GPU model and count
...
**Contract Info:**
<Frame>
  <img src="/images/console-instance-guide-12-light.webp" className="block dark:hidden" alt="Contract info" />
  <img src="/images/console-instance-guide-12-dark.webp" className="hidden dark:block" alt="Contract info" />
</Frame>
...
<Frame>
  <img src="/images/console-instance-guide-5-light.webp" className="block dark:hidden" alt="Stop and Destroy buttons" />
  <img src="/images/console-instance-guide-5-dark.webp" className="hidden dark:block" alt="Stop and Destroy buttons" />
</Frame>
...
<Frame>
  <img src="/images/console-instance-guide-13-light.webp" className="block dark:hidden" alt="Additional controls" />
  <img src="/images/console-instance-guide-13-dark.webp" className="hidden dark:block" alt="Additional controls" />
</Frame>
...
<Frame caption="Data movement">
  <img src="/images/console-instance-guide-7-light.webp" className="block dark:hidden" alt="Data movement" />
  <img src="/images/console-instance-guide-7-dark.webp" className="hidden dark:block" alt="Data movement" />
</Frame>

- **Copy Data** - Transfer between your instances (see [Data Movement](/guides/instances/storage/data-movement))
- **Cloud Sync** - Sync with cloud providers (see [Cloud Sync](/guides/instances/storage/cloud-sync))
...
For detailed connection instructions, see [Connect to Instances](/guides/instances/connect/overview):
...
<CardGroup cols={3}>
  ...
  <Card title="Reserved Instances" href="/guides/instances/choosing/reserved-instances" icon="calendar">
    Save up to 50% with long-term commitments
  </Card>
  <Card title="Instance Portal" href="/guides/instances/instance-portal" icon="browser">
