...
"canonical": "/guides/instances/choosing/overview"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Choosing a Template" href="/guides/instances/choosing/templates" icon="cube">
    Understanding and selecting templates for your needs
  </Card>
  <Card title="Finding & Renting" href="/guides/instances/choosing/find-and-rent" icon="search">
    Search, filter, configure, and rent GPU instances
  </Card>
  <Card title="Reserved Instances" href="/guides/instances/choosing/reserved-instances" icon="badge-dollar">
...
- **Disk size**: Can be grown in place via `vastai update instance <ID> --disk <new_size_gb>` (subject to host capacity); cannot be shrunk
