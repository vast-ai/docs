...
- **SLA (optional):** Available on **on-demand** rentals only. Set a **reliability target** in Search before clicking **RENT** to opt in — see [SLA Coverage](/guides/instances/choosing/sla-coverage).
