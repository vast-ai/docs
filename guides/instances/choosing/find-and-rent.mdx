...
- **SLA (optional):** Available on **on-demand** rentals only. Set a **reliability target** in Search, then confirm the price breakdown includes an **SLA charge** line before clicking **RENT** — see [SLA Coverage](/guides/instances/choosing/sla-coverage).
