...
"canonical": "/guides/instances/storage/data-movement"
---
...
<Frame caption="Cloud Sync">
  ![Cloud Sync](/images/data-movement-cloud-sync.webp)
</Frame>

See [Cloud Sync](/guides/instances/cloud-sync) for more details.

### Using the CLI

You can also access this feature using the `vastai cloud copy` [CLI command](/cli/reference/cloud-copy).
...
<Frame caption="Instance to Instance Copy">
  ![Instance to Instance Copy](/images/data-movement-itoicopy.gif)
</Frame>
...
<Frame caption="Copy Modal">
  ![Copy Modal](/images/instances-storage-copy-modal.webp)
</Frame>
...
You can also access this feature using the `vastai copy` [CLI command](/cli/reference/copy).

## CLI Copy Command

You can use the [CLI](/cli/hello-world) copy command to copy from/to directories on a remote instance and your local machine, or to copy data between two remote instances.
...
If your data is already stored in the cloud (S3, gdrive, etc) then you should naturally use the appropriate linux CLI or commands to download and upload data directly, or you could use the [Cloud Sync](/guides/instances/cloud-sync) feature.
...
The [Cloud Sync feature](/guides/instances/cloud-sync) will allow you to move data to and from instances easily.
