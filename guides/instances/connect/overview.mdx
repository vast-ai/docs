...
"canonical": "/guides/instances/connect/overview"
---
...
<CardGroup cols={2}>
  <Card title="SSH Access" href="/guides/instances/connect/ssh" icon="terminal">
    Terminal access with port forwarding and VS Code support
  </Card>
  <Card title="Jupyter Lab" href="/guides/instances/connect/jupyter" icon="notebook">
...
<CardGroup cols={2}>
  <Card title="Instance Portal" href="/guides/instances/connect/instance-portal" icon="browser">
    Web access to any application via secure tunnels
  </Card>
  <Card title="Port Networking" href="/guides/instances/connect/networking" icon="network-wired">
...
More information on [SSH/SCP](/guides/instances/connect/ssh)
...
More information on [Jupyter and installing the certificate](/guides/instances/connect/jupyter)
