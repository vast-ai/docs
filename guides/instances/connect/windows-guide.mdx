...
"canonical": "/guides/instances/connect/windows-guide"
---
...
<Note>
  This guide will focus only on **Windows GUI tools.**  If you would like to proceed with the CLI, please navigate to the [full SSH guide](/guides/instances/sshscp) for setup information.
</Note>
