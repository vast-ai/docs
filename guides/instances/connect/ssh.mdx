...
<Frame caption="Terminal Connections">
...
```bash Bash
ssh -p 50449 root@154.64.230.50 -L 8080:localhost:8080

The authenticity of host '[154.64.230.50]:50449 ([154.64.230.50]:50449)' can't be established.
