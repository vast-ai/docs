...
"canonical": "/guides/instances/docker-environment"
---


Vast.ai instances run as Linux Docker containers. Your [template](/guides/templates/introduction) (or CLI command) controls most of the parameters to the underlying `docker create` call, while resource constraints are configured automatically by the platform.
...
Vast.ai supports three launch modes: **Entrypoint**, **SSH**, and **Jupyter**. For full details, see [Connection Methods](/guides/instances/connect/overview).
...
For detailed networking information, see [Networking & Ports](/guides/instances/connect/networking).
