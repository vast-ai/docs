...
<Frame caption="Your balance appears at the top right of the dashboard.">
  <img src="/images/guides-overview-quick-start-light.webp" className="block dark:hidden" alt="Billing page with credit balance in top right" />
  <img src="/images/guides-overview-quick-start-dark.webp" className="hidden dark:block" alt="Billing page with credit balance in top right" />
</Frame>
