...
"canonical": "/guides/get-started/quickstart"
---
...
- Learn about [autobilling](/guides/reference/billing#autobilling-credit-card-only) to avoid interruptions.
  ...
  <img src="/images/guides-overview-quick-start-light.webp" className="block dark:hidden" alt="Billing" />
  <img src="/images/guides-overview-quick-start-dark.webp" className="hidden dark:block" alt="Billing" />
- Your balance appears at the top right of the dashboard.


  <img src="/images/guides-overview-quick-start-2-light.webp" className="block dark:hidden" alt="Credit balance in nav" />
  <img src="/images/guides-overview-quick-start-2-dark.webp" className="hidden dark:block" alt="Credit balance in nav" />
