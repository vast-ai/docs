...
"canonical": "/guides/teams/teams-roles"
---
...
<Frame caption="Default Roles">
  <img src="/images/teams-roles-light.webp" className="block dark:hidden" alt="Default Roles" />
<img src="/images/teams-roles-dark.webp" className="hidden dark:block" alt="Default Roles" />
</Frame>
...
<Frame caption="Edit Role">
  <img src="/images/teams-roles-2-light.webp" className="block dark:hidden" alt="Edit Role" />
  <img src="/images/teams-roles-2-dark.webp" className="hidden dark:block" alt="Edit Role" />
</Frame>
...
For more information on Permissions [click here](/api-reference/permissions).
