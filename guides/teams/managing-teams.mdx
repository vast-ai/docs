...
"canonical": "/guides/teams/managing-teams"
---
...
<img src="/images/console-members-light.webp" className="block dark:hidden" alt="Members Page" />
<img src="/images/console-members-dark.webp" className="hidden dark:block" alt="Members Page" />
...
<Frame caption="Invite Member">
  <img src="/images/teams-quickstart-6-light.webp" className="block dark:hidden" alt="Invite Member" />
<img src="/images/teams-quickstart-6-dark.webp" className="hidden dark:block" alt="Invite Member" />
</Frame>
...
<img src="/images/console-members-2-light.webp" className="block dark:hidden" alt="Roles" />
<img src="/images/console-members-2-dark.webp" className="hidden dark:block" alt="Roles" />
</Frame>
...
For detailed information about creating custom roles with specific permissions, see the [Teams Roles](/guides/teams/teams-roles) documentation.
...
<img src="/images/teams-quickstart-edit-light.webp" className="block dark:hidden" alt="Edit team" />
<img src="/images/teams-quickstart-edit-dark.webp" className="hidden dark:block" alt="Edit team" />

The 'Edit team name' option opens a pop-up that allows you to enter and save a new team name.

<Frame caption="Edit team">
<img src="/images/teams-quickstart-edit-2-light.webp" className="block dark:hidden" alt="Edit team" />
<img src="/images/teams-quickstart-edit-2-dark.webp" className="hidden dark:block" alt="Edit team" />
</Frame>
...
<Frame caption="Three-dot menu">
  <img src="/images/teams-transfer-light.webp" className="block dark:hidden" alt="Three-dot menu" />
  <img src="/images/teams-transfer-dark.webp" className="hidden dark:block" alt="Three-dot menu" />
</Frame>
...
<Frame caption="Transfer Team Ownership pop-up">
  <img src="/images/teams-transfer-2-light.webp" className="block dark:hidden" alt="Transfer Team Ownership pop-up" />
  <img src="/images/teams-transfer-2-dark.webp" className="hidden dark:block" alt="Transfer Team Ownership pop-up" />
</Frame>
