...
<Frame>
  <img src="/images/console-card-ssh-tooltip-light.webp" className="block dark:hidden" alt="Add/remove SSH keys icon on instance card" />
  <img src="/images/console-card-ssh-tooltip-dark.webp" className="hidden dark:block" alt="Add/remove SSH keys icon on instance card" />
</Frame>
