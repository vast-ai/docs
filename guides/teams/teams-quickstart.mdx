...
"canonical": "/guides/teams/teams-quickstart"
---
...
<Frame caption="Create Team">
  <img src="/images/teams-quickstart-light.webp" className="block dark:hidden" alt="Create Team" />
<img src="/images/teams-quickstart-dark.webp" className="hidden dark:block" alt="Create Team" />
</Frame>

<Frame caption="Members Page">
  <img src="/images/teams-quickstart-2-light.webp" className="block dark:hidden" alt="Members Page" />
<img src="/images/teams-quickstart-2-dark.webp" className="hidden dark:block" alt="Members Page" />
</Frame>
...
<Frame caption="Team Creation">
  <img src="/images/teams-quickstart-3-light.webp" className="block dark:hidden" alt="Team Creation" />
<img src="/images/teams-quickstart-3-dark.webp" className="hidden dark:block" alt="Team Creation" />
</Frame>
...
<Frame caption="Members Page">
  <img src="/images/teams-quickstart-4-light.webp" className="block dark:hidden" alt="Members Page" />
<img src="/images/teams-quickstart-4-dark.webp" className="hidden dark:block" alt="Members Page" />
</Frame>
...
<Frame caption="Create Role with custom permissions">
  <img src="/images/teams-quickstart-5-light.webp" className="block dark:hidden" alt="Create Role with custom permissions" />
<img src="/images/teams-quickstart-5-dark.webp" className="hidden dark:block" alt="Create Role with custom permissions" />
</Frame>
...
<Frame caption="Team Members">
  <img src="/images/teams-quickstart-7-light.webp" className="block dark:hidden" alt="Team Members" />
<img src="/images/teams-quickstart-7-dark.webp" className="hidden dark:block" alt="Team Members" />
</Frame>
...
<Frame>
  ![Add/remove SSH keys icon on instance card](/images/console-card-ssh-tooltip.webp)
</Frame>
