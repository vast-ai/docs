...
"canonical": "/guides/reference/keys"
---
...
<img src="/images/console-keys-2-light.webp" className="block dark:hidden" alt="SSH Keys empty section" />
<img src="/images/console-keys-2-dark.webp" className="hidden dark:block" alt="SSH Keys empty section" />
</Frame>

Add a new ssh key by clicking on the **+New** button. Copy and paste your key into the input in order for it to be attached to your account. You can use this ssh key to log into instances remotely. More [here](/guides/instances/sshscp).

<Frame caption="Add SSH Key">
<img src="/images/console-keys-3-light.webp" className="block dark:hidden" alt="Add SSH Key" />
<img src="/images/console-keys-3-dark.webp" className="hidden dark:block" alt="Add SSH Key" />
</Frame>
...
<Frame caption="SSH Keys">
  <img src="/images/console-keys-4-light.webp" className="block dark:hidden" alt="SSH Keys" />
  <img src="/images/console-keys-4-dark.webp" className="hidden dark:block" alt="SSH Keys" />
</Frame>

You can edit an existing ssh key by clicking on the **Edit** button and changing the text.

<Frame caption="Edit SSH Key">
  <img src="/images/console-keys-5-light.webp" className="block dark:hidden" alt="Edit SSH Key" />
  <img src="/images/console-keys-5-dark.webp" className="hidden dark:block" alt="Edit SSH Key" />
</Frame>
...
<img src="/images/console-keys-6-light.webp" className="block dark:hidden" alt="API Keys" />
<img src="/images/console-keys-6-dark.webp" className="hidden dark:block" alt="API Keys" />
...
<img src="/images/console-keys-7-light.webp" className="block dark:hidden" alt="API Keys permissions" />
<img src="/images/console-keys-7-dark.webp" className="hidden dark:block" alt="API Keys permissions" />
...
<img src="/images/console-keys-light.webp" className="block dark:hidden" alt="Session Keys" />
<img src="/images/console-keys-dark.webp" className="hidden dark:block" alt="Session Keys" />