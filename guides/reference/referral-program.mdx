...
"canonical": "/guides/reference/referral-program"
---
...
2. Go to [**Settings**](https://cloud.vast.ai/account/) → **Referral Link**.
  ...
  <img src="/images/console-referral-light.webp" className="block dark:hidden" alt="Referral Link" />
  <img src="/images/console-referral-dark.webp" className="hidden dark:block" alt="Referral Link" />
  </Frame>
3. Copy the link.
4. Share it!
...
Create [your own template](/guides/templates/creating-templates) for a use case, set it to **public**, then share its **template referral link.** The link will have this format:
...
<Frame caption="Template Card">
  <img src="/images/console-referral-2-light.webp" className="block dark:hidden" alt="Three-dot menu" />
  <img src="/images/console-referral-2-dark.webp" className="hidden dark:block" alt="Three-dot menu" />
</Frame>
