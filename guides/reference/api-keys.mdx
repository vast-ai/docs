...
2. Find the **API Keys** section and click **+New**.
   ...
   <Frame>
     <img src="/images/console-keys-6-light.webp" className="block dark:hidden" alt="New API key" />
     <img src="/images/console-keys-6-dark.webp" className="hidden dark:block" alt="New API key" />
   </Frame>
...
4. Select the permissions for this key. Defaults to full access; restrict for scoped keys (see below).
   ...
   <Frame>
     <img src="/images/console-keys-7-light.webp" className="block dark:hidden" alt="API key permissions" />
     <img src="/images/console-keys-7-dark.webp" className="hidden dark:block" alt="API key permissions" />
   </Frame>
