...
API keys authenticate your requests to the Vast.ai CLI, SDK, and REST API. You'll need a key for any programmatic access; the web console works without one.
