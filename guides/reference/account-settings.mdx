...
![Enable Dark Mode Section](/images/account-settings-enable-dark-mode-section.webp)
</Frame>
...
![Account Security Section](/images/account-settings-account-security-section.webp)
</Frame>
...
![Two Factor Authentication](/images/account-settings-two-factor-authentication.webp)
</Frame>
...
![Resend Verification Email](/images/account-settings-resend-verification-email.webp)
</Frame>
...
![Change Email](/images/account-settings-change-email.webp)
</Frame>
...
![Reset Password](/images/account-settings-reset-password.webp)
</Frame>
...
![Referral Link Section](/images/account-settings-referral-link-section.webp)
</Frame>
...
![Referral Link Fields](/images/account-settings-referral-link-fields.webp)
</Frame>
...
![Env Section](/images/account-settings-env-section.webp)
</Frame>
...
![Env Fields](/images/account-settings-env-fields.webp)
</Frame>
...
![Env Batch Paste](/images/account-settings-env-batch-paste.webp)
</Frame>
...
Use Notification Settings to choose which account, billing, and instance events reach you by email, in the console, or through webhooks. See [Notifications](/guides/reference/notifications) for the full setup guide.
...
![Cloud Connection Section](/images/account-settings-cloud-connection-section.webp)
</Frame>
...
![Cloud Connection Fields](/images/account-settings-cloud-connection-fields.webp)
</Frame>
...
![Invoice Information Section](/images/account-settings-invoice-information-section.webp)
</Frame>
...
![Invoice Information Fields](/images/account-settings-invoice-information-fields.webp)
</Frame>
