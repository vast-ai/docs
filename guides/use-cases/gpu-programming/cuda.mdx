...
- [(Optional) Install TLS Certificate for Jupyter]{href="https://docs.vast.ai/instances/jupyter" newTab="true" hasDisabledNofollow="false"}
...
- [(Optional) Vast-cli installed on your local machine for command-line management]{href="https://docs.vast.ai/cli" newTab="true" hasDisabledNofollow="false"}
- [(Optional) Docker knowledge for customizing development environments]{href="https://docs.docker.com/get-started/" newTab="true" hasDisabledNofollow="false"}

## Setup

### 1. Selecting the Right Template

Navigate to the [Templates tab]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"} to view recommended templates.

Search for [NVIDIA CUDA]{href="https://cloud.vast.ai?ref_id=62897&template_id=61e14a0dd1f97aa0aa6719d20bc9b02e" newTab="true" hasDisabledNofollow="false"} template if:
...
[Make a custom CUDA template]{href="https://docs.vast.ai/creating-a-custom-template" newTab="true" hasDisabledNofollow="false"} if:
...
- You're using [VSCode Remote-SSH]{href="https://code.visualstudio.com/docs/remote/ssh" newTab="true" hasDisabledNofollow="false"} or other IDE integrations
...
Select your desired GPU configuration based on your computational needs from the [Search tab]{href="https://cloud.vast.ai/create/" newTab="true" hasDisabledNofollow="false"}. For CUDA development, consider:&#x20;
...
Go to [Instances tab]{href="https://cloud.vast.ai/instances/" newTab="true" hasDisabledNofollow="false"} to see your instance being created. There are multiple ways to connect to your instance:
...
- If you selected SSH launch mode:
  ...
  - You take the ssh command and execute in your terminal in your [Mac or Linux-based computer or in Powershell]{href="https://docs.vast.ai/instances/sshscp" newTab="true" hasDisabledNofollow="false"}
  - You can use [Powershell or Windows Putty tools]{href="https://docs.vast.ai/instances/sshscp" newTab="true" hasDisabledNofollow="false"} if you have a Windows computer
...
Configure VS Code or other IDEs for [remote development]{href="https://code.visualstudio.com/docs/remote/ssh" newTab="true" hasDisabledNofollow="false"}:
