...
2. **Select the Ollama template:** click on [temp]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"}[lates]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"} and select the recomended Ollama template **Open Webui (Ollama).&#x20;**&#x43;lick on the play icon to select the template. You will then go to the search menu to find a GPU.&#x20;
