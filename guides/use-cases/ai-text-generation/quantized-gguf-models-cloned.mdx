...
A full guide to getting started with the OpenWebUI template is available [here]{href="https://docs.vast.ai/ollama-webui" newTab="true" hasDisabledNofollow="false"}
...
You will want to download the models from the [Deepseek-R1 Q8\_0 model]{href="https://huggingface.co/unsloth/DeepSeek-R1-GGUF" newTab="true" hasDisabledNofollow="false"} hugging face repo to the `/workspace/llama.cpp/models` directory on your instance. We have included a script with the [Ollama + Open WebUI]{href="https://cloud.vast.ai?ref_id=62897&template_id=d8aa06abd242979cee20d6646068167d" newTab="true" hasDisabledNofollow="false"} template that you may use to easily download the models.
...
For advanced build instructions you should see the [official documentation]{href="https://github.com/ggerganov/llama.cpp?tab=readme-ov-file#building-the-project" newTab="true" hasDisabledNofollow="false"} on GitHub.&#x20;
