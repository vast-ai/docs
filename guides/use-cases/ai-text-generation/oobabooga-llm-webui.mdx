...
Go to the [Templates tab]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"} and search for "Oobabooga" among recommended templates and select it.
...
![Ooobaboogasize](https://vast.ai/uploads/Oobabooga/OoobaboogaSize.png "Ooobaboogasize")
...
![Oobaboogasearch](https://vast.ai/uploads/Oobabooga/Oobaboogasearch.png "Oobaboogasearch")
...
![Oob Downloading](https://vast.ai/uploads/oob-downloading.JPG "Oob Downloading")
...
![Oob Model Load](https://vast.ai/uploads/oob-model-load.JPG "Oob Model Load")
