...
- A Vast.ai account
- [SSH client installed on your local machine and SSH public key added the Keys section at cloud.vast.ai]{href="https://docs.vast.ai/instances/sshscp" newTab="true" hasDisabledNofollow="false"}&#x20;
...
Go to [Templates tab]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"} and search for recommended Ubuntu 22.04 VM template.
...
Rent a machine of your choice from the [Search tab]{href="https://cloud.vast.ai/create/" newTab="true" hasDisabledNofollow="false"}.

You can see the instance being created in the Instances tab. It can take some time to load.

## Connect to Your VM

Once the blue button the instance card says **>\_CONNECT**, you can click the button and copy the ssh command to execute in your terminal in your Mac or Linux-based computer. You can also use [Powershell or Windows Putty tools]{href="https://docs.vast.ai/instances/sshscp" newTab="true" hasDisabledNofollow="false"} if you have a Windows computer.
...
- [Vast.ai Discord]{href="https://discord.gg/hSuEbSQ4X8" newTab="true" hasDisabledNofollow="false"}
- [Support chat at Vast.ai]{href="https://vast.ai/" newTab="true" hasDisabledNofollow="false"}
