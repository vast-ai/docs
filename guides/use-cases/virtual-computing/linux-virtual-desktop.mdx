...
1. Navigate to the [Templates tab]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"}&#x20;
...
- Configure TLS (Optional):
  - [Install the 'Jupyter' certificate]{href="https://docs.vast.ai/instances/jupyter" newTab="true" hasDisabledNofollow="false"} following the instance setup guide&#x20;
...
1. [Install Tailscale ]{href="https://tailscale.com/kb/1347/installation" newTab="true" hasDisabledNofollow="false"}on your local device. Password is "password" if you haven't changed it.&#x20;
...
- Create [secure tunnels]{href="https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/get-started/" newTab="true" hasDisabledNofollow="false"} without exposing ports and having to create a new instance
...
- [Tailscale Documentation]{href="https://tailscale.com/kb/" newTab="true" hasDisabledNofollow="false"}
- [Cloudflare Tunnels]{href="https://developers.cloudflare.com/cloudflare-one/connections/connect-apps/" newTab="true" hasDisabledNofollow="false"}
