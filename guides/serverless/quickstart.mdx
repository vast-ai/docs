...
<Steps>
  ...
  <Step title="Open the Serverless Dashboard">
    ...
    <img src="/images/serverless/quickstart_modal_light.webp" className="block dark:hidden" alt="Quickstart modal" />
    <img src="/images/serverless/quickstart_modal_dark.webp" className="hidden dark:block" alt="Quickstart modal" />
  </Step>
  ...
  <Step title="Name Your Endpoint and Select a Workload">
    ...
    <img src="/images/serverless/quickstart_dropdown_light.webp" className="block dark:hidden" alt="Workload type dropdown" />
    <img src="/images/serverless/quickstart_dropdown_dark.webp" className="hidden dark:block" alt="Workload type dropdown" />

    For this quickstart, select **LLM Inference**.

    <img src="/images/serverless/quickstart_selected_light.webp" className="block dark:hidden" alt="LLM Inference selected" />
    <img src="/images/serverless/quickstart_selected_dark.webp" className="hidden dark:block" alt="LLM Inference selected" />
  ...
  <Step title="Start Making Requests">
    ...
    <img src="/images/serverless/quickstart_congrats_light.webp" className="block dark:hidden" alt="Endpoint created successfully" />
    <img src="/images/serverless/quickstart_congrats_dark.webp" className="hidden dark:block" alt="Endpoint created successfully" />
