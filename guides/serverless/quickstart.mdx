...
<Steps>
  ...
  <Step title="Name Your Endpoint and Select a Workload">
    ...
    <Note>
      For more control over endpoint parameters and workergroup configuration, click **"Advanced setup"** instead. See [Setting Up Endpoints](/guides/serverless/advanced-quickstart) for details.
    </Note>
  </Step>
