...
"canonical": "/guides/serverless/logging"
---
...
<Frame caption="Endpoint Log">
  <img src="/images/endpoint-log-light.webp" className="block dark:hidden" alt="Endpoint Log" />
  <img src="/images/endpoint-log-dark.webp" className="hidden dark:block" alt="Endpoint Log" />
</Frame>
