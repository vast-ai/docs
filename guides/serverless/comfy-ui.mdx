...
"canonical": "/guides/serverless/comfy-ui"
---
...
<Note>
  Before using this template, familiarize yourself with the [Serverless Documentation](/guides/serverless/overview) and [Getting Started With Serverless](/guides/serverless/getting-started-with-serverless) guide.
</Note>
