...
<Note>
  Before using this template, familiarize yourself with the [Serverless Documentation](/guides/serverless/overview) and [Serverless Quickstart](/guides/serverless/quickstart). Learn more about Wan 2.2 T2V A14B on [Hugging Face](https://huggingface.co/Wan-AI/Wan2.2-T2V-A14B).
</Note>
