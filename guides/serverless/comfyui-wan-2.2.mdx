...
"canonical": "/guides/serverless/comfyui-wan-2.2"
---
...
<Note>
  Before using this template, familiarize yourself with the [Serverless Documentation](/guides/serverless/overview) and [Getting Started With Serverless](/guides/serverless/getting-started-with-serverless) guide. Learn more about Wan 2.2 T2V A14B on [Hugging Face](https://huggingface.co/Wan-AI/Wan2.2-T2V-A14B).
</Note>
