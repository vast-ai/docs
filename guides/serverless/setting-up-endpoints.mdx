...
<Steps>
  ...
  <Step title="Open the Create Endpoint Dialog">
    ...
    <img src="/images/serverless/create_endpoint_light.webp" className="block dark:hidden" alt="Create Endpoint dialog" />
    <img src="/images/serverless/create_endpoint_dark.webp" className="hidden dark:block" alt="Create Endpoint dialog" />
  </Step>

  <Step title="Configure Advanced Parameters">
    Click **"Advanced"** to expand the full set of scaling parameters. These give you the fine-grained control that sets this flow apart from the [Quickstart](/guides/serverless/quickstart):
    ...
    <img src="/images/serverless/create_endpoint_advanced_light.webp" className="block dark:hidden" alt="Create Endpoint advanced parameters" />
    <img src="/images/serverless/create_endpoint_advanced_dark.webp" className="hidden dark:block" alt="Create Endpoint advanced parameters" />
  ...
  <Step title="Select a Template">
    ...
    <img src="/images/serverless/create_workergroup_template_light.webp" className="block dark:hidden" alt="Create Workergroup - Template selection" />
    <img src="/images/serverless/create_workergroup_template_dark.webp" className="hidden dark:block" alt="Create Workergroup - Template selection" />
  ...
  <Step title="Select GPU Instances">
    ...
    <img src="/images/serverless/create_workergroup_light.webp" className="block dark:hidden" alt="Create Workergroup - GPU selection" />
    <img src="/images/serverless/create_workergroup_dark.webp" className="hidden dark:block" alt="Create Workergroup - GPU selection" />
  ...
  <Step title="Wait for Workers to Initialize">
    ...
    <img src="/images/serverless/workers_loading_light.webp" className="block dark:hidden" alt="Workers loading in the dashboard" />
    <img src="/images/serverless/workers_loading_dark.webp" className="hidden dark:block" alt="Workers loading in the dashboard" />
    ...
    <img src="/images/serverless/workers_progress_light.webp" className="block dark:hidden" alt="Workers progressing through initialization" />
    <img src="/images/serverless/workers_progress_dark.webp" className="hidden dark:block" alt="Workers progressing through initialization" />
...
<img src="/images/serverless/edit_endpoint_light.webp" className="block dark:hidden" alt="Edit Endpoint dialog" />
<img src="/images/serverless/edit_endpoint_dark.webp" className="hidden dark:block" alt="Edit Endpoint dialog" />

Click **"Advanced"** to access additional scaling controls:

<img src="/images/serverless/edit_endpoint_advanced_light.webp" className="block dark:hidden" alt="Edit Endpoint advanced parameters" />
<img src="/images/serverless/edit_endpoint_advanced_dark.webp" className="hidden dark:block" alt="Edit Endpoint advanced parameters" />
