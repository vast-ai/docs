...
"canonical": "/guides/serverless/architecture"
---
...
<Frame caption="Serverless Architecture">
  <img src="/images/serverless-architecture-light.svg" className="block dark:hidden" alt="Serverless Architecture" />
  <img src="/images/serverless-architecture-dark.svg" className="hidden dark:block" alt="Serverless Architecture" />
</Frame>
...
The [Serverless SDK](./sdk-overview) is the primary interface for interacting with Vast Serverless. It is a Python `pip` package that abstracts low-level details and manages:
