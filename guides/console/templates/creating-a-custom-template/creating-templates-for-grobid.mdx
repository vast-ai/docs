...
This guide will give an example as to how you can find and configure a template for GROBID. This is an extension of our Create Templates With Custom Templates. We will be using the image from [GROBID on dockerhub](https://hub.docker.com/r/grobid/grobid).
...
![](/images/console-create-custom-template-grobid.webp)
...
![](/images/console-create-custom-template-grobid-2.webp)
...
![](/images/console-create-custom-template-grobid-3.webp)
...
![](/images/console-create-custom-template-grobid-4.webp)
...
![](/images/console-create-custom-template-grobid-5.webp)
