...
- A Vast.ai account
- :Link[SSH client installed on your local machine and SSH public key added in the SSH Keys tab in the Keys section of your console]{href="https://cloud.vast.ai/manage-keys/" newTab="true" hasDisabledNofollow="false"}&#x20;
- :Link[(Optional) Install and use vast-cli]{href="https://docs.vast.ai/cli" newTab="true" hasDisabledNofollow="false"}&#x20;
...
1. Go to the :Link[Templates tab ]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"}in Vast.ai interface
...
![](https://archbee-image-uploads.s3.amazonaws.com/DXSM3LlVb4llv9ZkijIZ9-ecTniHpPJjmzK40ccpJ0g-20250211-200512.png "Add PROVISIONING_SCRIPT variable")
...
1. Start with a :Link[Vast.ai base image]{href="https://hub.docker.com/r/vastai/base-image/tags" newTab="true" hasDisabledNofollow="false"} or :Link[Vast.ai Pytorch base image]{href="https://hub.docker.com/r/vastai/pytorch/tags" newTab="true" hasDisabledNofollow="false"} in your Dockerfile:
...
- :Link[Build]{href="https://docs.docker.com/build/" newTab="true" hasDisabledNofollow="false"} and :Link[push your image]{href="https://docs.docker.com/reference/cli/docker/image/push/" newTab="true" hasDisabledNofollow="false"} to a container registry
...
![Create](https://vast.ai/uploads/templates/Create.jpg "Create")
...
![Image\&Tag](https://vast.ai/uploads/templates/Image\&Tag.png "Image\&Tag")
...
![Env\&Stuff](https://vast.ai/uploads/templates/Env\&Stuff.png "Env\&Stuff")
...
[FAQ: How can I Open Custom Ports](./../../Overview/FAQ.mdx)&#x20;
...
![Exampleonstart](https://vast.ai/uploads/templates/ExampleOnstart.png "Exampleonstart")
...
![Dockerlogin](https://vast.ai/uploads/templates/DockerLogin.png "Dockerlogin")

### Step 10 - Specify Template Name and Description

![Templatename](https://vast.ai/uploads/templates/TemplateName.png "Templatename")

### Step 11- Select the Amount of Disk Space You Want

![Diskspace2](https://vast.ai/uploads/templates/DiskSpace2.png "Diskspace2")
...
![Readme](https://vast.ai/uploads/templates/Readme.png "Readme")

### Step 13 - Choose to Save And/Or Select Your Template

A new template will be created when you edit, make changes, and save.

![Createbuttons](https://vast.ai/uploads/templates/CreateButtons.png "Createbuttons")
...
- If your image is built for a different CPU architecture than your Vast machine, then it won't work. You can try to find a machine with the required CPU architecture using our GUI or CLI. :Link[CLI Documentation]{href="https://docs.vast.ai/cli" newTab="true" hasDisabledNofollow="false"}  [Command to Search Offers Using CLI]()&#x20;
...
:Link[Creating Templates for GROBID]{href="https://docs.vast.ai/creating-templates-for-grobid" newTab="true" hasDisabledNofollow="false"}
