...
2. Go to [**Settings**](https://cloud.vast.ai/account/) → **Referral Link**.
   ...
   ![Referral Likn](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/qCzfZMxkdMQCrQP8GJ0IP_image.png "Account Settings")
3. Copy the link.
4. Share it!
...
![Three-dot menu](https://archbee-image-uploads.s3.amazonaws.com/9WtD9F5n1L2IYJxS0qXDd/tt84D0WJEPg7BieLDZhLc_image.png "Template Card")
