...
1. **Setup your Vast account and add credit:** Review the [quickstart guide](/guides/get-started/quickstart) to get familar with the service if you do not have an account with credits loaded.
...
![Gradio application for speech generation with Dia TTS model](/images/use-cases-ai-audio-generation.webp)
</Frame>
