---
title: Overview
description: Learn about Vast.ai's Serverless system: the Vast PyWorker, integration with model instances, communication with the serverless system, and creating custom backends. Understand how the system works, how to integrate with models, and how to create your own backends.
...
1. Sends a [`/route/`](https://docs.vast.ai/serverless/route) POST request to the serverless system. This asks the system for a GPU instance to send the inference request.
...
- [Creating New PyWorkers](https://docs.vast.ai/serverless/creating-new-pyworkers)

## Vast Supported Backends

Vast has pre-made templates for popular models such as [Text-Generation-Inference](https://docs.vast.ai/serverless/text-generation-inference-tgi)
...
To get started with Vast-supported backends, see the [Inside a Severless GPU](https://docs.vast.ai/serverless/inside-a-serverless-gpu) guide.
