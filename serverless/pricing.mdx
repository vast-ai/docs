---
title: Pricing
description: Learn how Vast.ai Serverless pricing works: GPU recruitment, endpoint suspension, and stopping. Understand how the system scales up and down based on demand, how to suspend an endpoint, and how to stop an endpoint.
