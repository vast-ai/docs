...
description: Learn about the components of a Serverless GPU instance: the core ML model, model server code, and PyWorker server code. Understand how the system works, how to add endpoints, and how to authenticate requests.
