...
The [Text Generation Inference serverless template]{href="https://cloud.vast.ai?ref_id=140778&template_id=e97e6c337efd5562ad419cdb392981a4" newTab="true" hasDisabledNofollow="false"} can be used to infer LLMs on Vast GPU instances. This page documents required environment variables and endpoints to get started.

A full PyWorker and Client implementation can be found [here]{href="https://github.com/vast-ai/pyworker/tree/main" newTab="true" hasDisabledNofollow="false"}.

# Environment Variables

- `HF_TOKEN`(string): HuggingFace API token with read permissions, used to download gated models. Read more about HuggingFace tokens [here]{href="https://huggingface.co/docs/hub/en/security-tokens" newTab="true" hasDisabledNofollow="false"}.
