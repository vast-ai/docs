...
slug: 755doS_etBSXtfevOrV7b
createdAt: Tue Jan 14 2025 01:54:58 GMT+0000 (Coordinated Universal Time)
updatedAt: Mon Jul 21 2025 22:29:03 GMT+0000 (Coordinated Universal Time)
---
...
3. The [PyWorker]{href="https://docs.vast.ai/serverless/overview" newTab="true" hasDisabledNofollow="false"} server code that wraps the ML model, which formats incoming HTTP requests into a compatible format for the model server.

![Backend diagram](https://archbee-image-uploads.s3.amazonaws.com/FhZr-Q9v-XzefBwGFb_3x-b8eeHBorQrlVO4Uul4drG-20250619-223401.png)
...
Vast also has pre-made backends in our supported templates, which can be found in the Serverless section [here]{href="https://cloud.vast.ai/templates/" newTab="true" hasDisabledNofollow="false"}.&#x20;
