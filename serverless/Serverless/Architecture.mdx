---
title: Architecture
slug: ODiCcZ_z8oP6OiiIeyDXf
createdAt: Mon Jan 13 2025 21:20:40 GMT+0000 (Coordinated Universal Time)
updatedAt: Mon Jul 21 2025 22:15:39 GMT+0000 (Coordinated Universal Time)
---
...
- **Worker Groups**: A lower level organization that lives within an Endpoint. It consists of a [template]{href="https://docs.vast.ai/instances/templates" newTab="true" hasDisabledNofollow="false"} (with extra filters for search), a set of GPU instances (workers) created from that template, and hyperparameters. Multiple Worker Groups can exist within an Endpoint.
...
You can create Worker Groups using our [Serverless-Compatible Templates]{href="https://docs.vast.ai/serverless/text-generation-inference-tgi" newTab="true" hasDisabledNofollow="false"}, which are customized versions of popular templates on Vast, designed to be used on the serverless system.
...
![](https://archbee-image-uploads.s3.amazonaws.com/pNFur-Vy38DOi0g2bo5iM-DJHBaaCdIEkPMBPfenURq-20250721-221537.png "Serverless Architecture")
