...
There is no default value for search\_params. To see all available search filters, see the CLI docs [here]{href="https://docs.vast.ai/api/commands#DtIdq" newTab="true" hasDisabledNofollow="false"}.
