---
title: vLLM
description: Learn how to use vLLM on Vast.ai to infer LLMs. Understand the required environment variables and endpoints to get started.
createdAt: Mon Jun 02 2025 21:09:22 GMT+0000 (Coordinated Universal Time)
updatedAt: Mon Aug 11 2025 20:26:34 GMT+0000 (Coordinated Universal Time)
---
...
- `HF_TOKEN`(string): HuggingFace API token with read permissions, used to download gated models. Read more about HuggingFace tokens [here](https://huggingface.co/docs/hub/en/security-tokens). This token should be added to your Vast user account's environment variables. The [Getting Started](https://docs.vast.ai/serverless/getting-started) guide shows this in step 1.
