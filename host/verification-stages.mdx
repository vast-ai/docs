...
```text Text
- CUDA version greater than or equal to 11.8 for the self-test image family
- Reliability of 90%
- At least 3 direct open ports per GPU. Each instance can use up to 64 ports, so mapping more than 64 ports per listed GPU is usually unnecessary
