...
Verification combines **automated screening** with **internal vetting**, incorporating [supply-and-demand](/host/understanding-verification#supply-demand) dynamics. Community machines are pre-scanned automatically and then vetted by Vast staff; large datacenter partners go through a dedicated manual verification process (see [Datacenter Status](/host/datacenter-status)).
...
- Reliability greater than 0.90
- At least 3 open ports per GPU
