...
<Note>
A drive that is wearing out or throwing media errors fails container starts and
costs the machine its verification, often while it still reports as healthy.
See [Check SSD Health](/host/ssd-health).
</Note>
