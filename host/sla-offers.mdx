...
**CLI `--sdate` uses Unix epoch seconds (UTC)**; the REST body uses ISO 8601 UTC:

```bash
# Example: 2026-08-01 02:00:00 UTC → epoch seconds
# Linux: date -u -d '2026-08-01 02:00:00' +%s
vastai schedule maint MACHINE_ID --sdate 1785549600 --duration 2 --maintenance_category planned
```
