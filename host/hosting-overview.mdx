...
- optional [SLA (reliability guarantee)](/host/sla-offers) parameters — reliability target, claim, and confidence
...
You won't be able to see it on the GUI right away, but you can search using the [CLI](/guides/instances/managing-instances).
