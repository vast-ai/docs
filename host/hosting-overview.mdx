...
- Leave Ubuntu's automatic security updates on, and plan kernel updates around your rentals so that your machine doesn't drop a client job to reboot. See [Automatic Security Updates](/host/security/automatic-security-updates).
