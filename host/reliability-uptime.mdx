...
Do not use `--ignore-requirements` as a verification shortcut. It is only useful for dogfooding or runtime validation, and the machine still needs enough direct ports for the runtime test to work.
