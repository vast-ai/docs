...
4. **Install the Vast host software.** Follow [Installing Host Software](/host/installing-host-software). Running over SSH only? Use the [Headless Install Path](/host/headless-install).
