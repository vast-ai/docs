...
- Pick a reliability target and confidence before you enable SLA on a listing
- Compare how premium and worst-case payout change across targets
...
| --- | --- | --- |
| 400 | `invalid_range`, `range_too_large`, `bad_request`, `invalid_params` | Invalid query parameters or simulation failure |
