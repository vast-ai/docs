...
For the full permission reference, see [API Permissions](/api-reference/permissions). The exact console flow for granting machine registration rights to a team API key or custom role needs engineering confirmation before this draft is published.
