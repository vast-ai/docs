...
- [(Optional) SSH client installed on your local machine and SSH public key added in Account tab at cloud.vast.ai](/guides/instances/sshscp)
...
2. When the blue button says "OPEN", click this button to access the [Instance Portal](/guides/instances/instance-portal) which will provide access to ComfyUI and other useful applications.
...
2. [Vast.ai Documentation](/guides/get-started/index)
