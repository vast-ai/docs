...
Your default main key allows full access to all commands without limitations, but you can use the CLI to create additional keys with [fine-grained access restrictions](https://docs.vast.ai/api/permissions-and-authorization).
...
You can [call stop/destroy instance from inside](https://docs.vast.ai/instances/docker-execution-environment) the instance using a special autogenerated instance apikey, to avoid exposing your main apikey.
