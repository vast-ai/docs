    ...
    "step": [
      {
        ...
        "text": "Install the latest stable PyPI release with: pip install vastai."
      },
      {
        "@type": "HowToStep",
...
This installs the open-source Python CLI for Vast.ai. The CLI has all of the functionality of the Vast.ai website GUI and uses the same underlying REST API.
...
For the most up to date help, use `vastai --help`. You can then get a list of the available commands. Each command also typically has help documentation:
