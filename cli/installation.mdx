...
- [Copy Data](https://docs.vast.ai/api-reference/instances/cloud-copy)
...
- [Get Team Role](https://docs.vast.ai/api-reference/accounts/show-team-role)
...
- [Delete Team Role](https://docs.vast.ai/api-reference/team/remove-team-role)
