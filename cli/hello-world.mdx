...
<Note>
`--onstart-cmd` is limited to **4048 characters**. For longer scripts, gzip and base64 encode them, see the [Template Settings](/guides/templates/template-settings#on-start-script) page for the workaround.
</Note>
