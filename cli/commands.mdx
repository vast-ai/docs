...
| [`vastai show instances`](#show-instances) | Display user's current instances |
| [`vastai show instances-v1`](#show-instances-v1) | List instances with filtering, sorting, and pagination |
...
| Command | Description |
| --- | --- |
| [`vastai show invoices`](#show-invoices) | (DEPRECATED) Get billing history reports |
| [`vastai show invoices-v1`](#show-invoices-v1) | Get billing (invoices/charges) history reports with advanced filtering and pagination |
