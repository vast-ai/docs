...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "TechArticle",
    "headline": "Disco Diffusion on Vast.ai (Deprecated)",
    "description": "Historical guide to running Disco Diffusion AI image generator on Vast.ai. This guide is deprecated - please see the Stable Diffusion guide for current recommendations.",
    "author": {
      "@type": "Organization",
      "name": "Vast.ai"
    },
    "articleSection": "Deprecated Guides",
    "keywords": ["Disco Diffusion", "deprecated", "AI image generation", "GPU", "vast.ai", "historical"]
  })
}} />
