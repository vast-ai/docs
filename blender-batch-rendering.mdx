...
![Highlighted Secure Cloud](/images/highlighted-secure-cloud.webp)
</Frame>
...
![Highlighted Rtx 4090 Filter Pic](/images/highlighted-rtx-4090-filter-pic.webp)
</Frame>
...
![Highlighted Rent](/images/highlighted-rent.webp)
</Frame>

## Step 5 - Use Jupyter Direct HTTPS Launch Mode

Follow the instructions related to adding a certificate to your browser if you need to when it asks you to "Setup Jupyter Direct HTTPS" and click "CONTINUE". Here's more information on the Jupyter direct HTTPS Launch Mode and Installing the TLS certificate: [Jupyter](/guides/instances/jupyter).

<Frame caption="Updated Jupyter Direct Https Continue">
![Updated Jupyter Direct Https Continue](/images/updated-jupyter-direct-https-continue.webp)
</Frame>

## Step 6 - Click the Open Button or Jupyter Notebook button to open Jupyter Notebook

<Frame caption="Jupyter Notebook Button">
![Jupyter Notebook Button](/images/jupyter-notebook-button.webp)
</Frame>
...
![Go Render Animation For Batch Folder](/images/blender-batch-rendering-go-render-animation-for-batch-folder.webp)
</Frame>
...
![Upload 100 Color Vortex](/images/blender-batch-rendering-upload-100-color-vortex.webp)
</Frame>

<br />

<Frame caption="Upload Render Animation Batch Highlighted">
![Upload Render Animation Batch Highlighted](/images/blender-batch-rendering-upload-render-animation-batch-highlighted.webp)
</Frame>
...
![Open Render Animation For Batch Folder Notebook](/images/blender-batch-rendering-open-render-animation-for-batch-folder-notebook.webp)
</Frame>
...
![Show Rendering Animations](/images/blender-batch-rendering-show-rendering-animations.webp)
</Frame>

<br />

<Frame caption="Click Run All Cells Highlighted">
![Click Run All Cells Highlighted](/images/blender-batch-rendering-click-run-all-cells-highlighted.webp)
</Frame>
...
![Go To Render Xth Frame For Batch Folder](/images/blender-batch-rendering-go-to-render-xth-frame-for-batch-folder.webp)
</Frame>
...
![Upload Blend Files For Xth Frame](/images/blender-batch-rendering-upload-blend-files-for-xth-frame.webp)
</Frame>

<br />

<Frame caption="Upload Xth Frame Highlighted">
![Upload Xth Frame Highlighted](/images/blender-batch-rendering-upload-xth-frame-highlighted.webp)
</Frame>
...
![Open Render Animation For Each Blend File In Batch Of Blend Files Ipynb](/images/blender-batch-rendering-open-render-animation-for-each-blend-file-in-batch-of-blend-files-ipynb.webp)
</Frame>
...
![Set Frame Number 2](/images/blender-batch-rendering-set-frame-number-2.webp)
</Frame>

Click the Run tab and click Run All Cells

<Frame caption="Xth Frames Rendering">
![Xth Frames Rendering](/images/blender-batch-rendering-xth-frames-rendering.webp)
</Frame>

<br />

<Frame caption="Run All Cells Xth Frame Highlighted">
![Run All Cells Xth Frame Highlighted](/images/blender-batch-rendering-run-all-cells-xth-frame-highlighted.webp)
</Frame>
