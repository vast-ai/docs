...
Autoresearch requires a single NVIDIA GPU with 80GB VRAM (H100 or A100 80GB). It needs CUDA 12.4+ and about 50GB of disk for the repo, data, and dependencies.

Search for available instances:

```bash
vastai search offers 'gpu_ram>=70 num_gpus=1 cuda_vers>=12.4 disk_space>=50 reliability>0.95' -o 'dph+'
```
...
H100 instances on Vast.ai typically cost **$1.50–2.50/hr**. An overnight run (~8 hours) costs roughly **$12–20** in compute, plus Claude API usage.
