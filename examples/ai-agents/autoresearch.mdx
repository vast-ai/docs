...
- [Vast CLI installed](/cli/hello-world) on your local machine
...
<Tabs>
  <Tab title="Use Template">
    ...
    <Card title="Learn more about templates" href="/guides/templates/introduction" icon="layer-group">
...
- [Vast.ai CLI reference](/cli/hello-world)
