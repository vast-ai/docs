---
title: Budget-Friendly Overnight Ralph Loop
...
# Budget-Friendly Overnight Ralph Loop on Vast

Run autonomous coding agents overnight for under $20, waking up to a completed project with passing tests.
