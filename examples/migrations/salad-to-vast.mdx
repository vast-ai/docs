...
Salad **Job Queues** let you distribute discrete tasks across container replicas -- you push work items to a queue, and Salad distributes them across nodes with auto-retry (up to 3 retries) and autoscaling up to 250 replicas.
