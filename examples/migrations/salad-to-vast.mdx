...
<script type="application/ld+json" dangerouslySetInnerHTML={{
  __html: JSON.stringify({
    ...
    "@type": "HowTo",
    "name": "Migrate from Salad Cloud to Vast.ai",
    "description": "A complete guide for moving GPU workloads from Salad Cloud to Vast.ai, covering concept mapping, account setup, container migration, serverless inference, storage, networking, and cost optimization.",
    "step": [
      {
        "@type": "HowToStep",
      ...
      {
        "@type": "HowToStep",
        "name": "Migrate your container workloads",
        "text": "Deploy your existing Salad Docker containers on Vast.ai with environment variables, startup scripts, and port mappings."
      },
      {
        "@type": "HowToStep",
        "name": "Set up storage",
        "text": "Use Vast persistent volumes and built-in cloud sync for model weights, datasets, and checkpoints."
      },
      {
        "@type": "HowToStep",
        "name": "Migrate autoscaling workloads",
        "text": "Move Salad Job Queue workloads to Vast Serverless with benchmark-driven GPU selection and autoscaling inference endpoints."
      }
    ],
    "author": {
      "@type": "Organization",
...
- **[Cloud Sync](/documentation/instances/storage/cloud-sync)**: Vast's built-in sync tool supports S3, Google Drive, Backblaze, and Dropbox. Access it via the console or `vastai cloud copy`.
...
- [Templates](/documentation/templates/introduction): save your configuration as a reusable template
- [Storage Types](/documentation/instances/storage/types): persistent volumes, cloud sync, and data movement
- [Finding & Renting Instances](/documentation/instances/choosing/find-and-rent): marketplace filters, reliability scores, and offer details
